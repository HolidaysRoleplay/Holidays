...
if (isset($_POST['btnannounc'])) {
    ...
    $announcement = $_POST['chat'];

    $insert = mysqli_query($dbuser, "INSERT INTO user_chat (username,chat) VALUES ('$username','$announcement')");
    if ($insert) {
        redirect("announcadmin");
    } else {
        echo 'gagal';
    }
}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button btn " class="close btn-secondary" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body ">
                    <form action="" method="POST">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="chat" required>
                        </div>
