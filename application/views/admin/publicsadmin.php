        ...
        <div class="subforum">
            ...
            <div class="subforum-row">
                ...
                <div class="subforum-description subforum-column">
                    <h1><a href="announcadmin" class="text-decoration-none text-light">Announcement</a></h1>
                    <a href="announcadmin" class=" text-decoration-none text-light">
                        <p>Server online</p>
                    </a>
                </div>
            </div>
        ...
        <div class="subforum">
            ...
            <div class=" subforum-row">
                ...
                <div class="subforum-description subforum-column text-decoration-none">
                    <h1 class="text-decoration-none text-light"><a href="<?= base_url('userguideadmin') ?>" class="text-decoration-none text-light">Staterpack</a></h1>
                    <a href="<?= base_url('userguideadmin') ?>" class="text-decoration-none text-light">
            ...
            <div class="subforum-row">
                ...
                <div class="subforum-description subforum-column text-decoration-none">
                    ...
                    <a href="" class="text-decoration-none text-light">
                        <p>Anda bisa pergi ke pemerintah untuk membuat passport</p>
                    </a>
                </div>
            </div>
            <div class="subforum-row">
                ...
                <div class="subforum-description subforum-column text-decoration-none">
                    <h1>Pin bank</h1>
                    <p>Anda bisa pergi ke bank untuk membuat pin bank anda</p>
                </div>
            </div>
        </div>
    </div>
